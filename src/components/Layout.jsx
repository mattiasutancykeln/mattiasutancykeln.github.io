/**
 * Inner pages shell: top nav bar (MA monogram, links, socials) + footer (PROJECT.md §4).
 * Landing (/) renders without nav/footer.
 */
...
export default function Layout() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
            ...
            <span style={{ color: 'var(--border)', fontSize: '0.9rem' }} aria-hidden>·</span>
            {NAV_LINKS.map(({ to, label }) => (
              <NavLink
                ...
                style={({ isActive }) => ({
                  ...
                  textDecoration: 'none',
                  padding: '0.25rem 0',
                  borderBottom: isActive ? '1px solid var(--accent-teal)' : '1px solid transparent',
      ...
      >
        Mattias Akke · Lund, Sweden · {new Date().getFullYear()}
      </footer>
    </div>
  );
}
